...
if(check){
    return res.status(400).json({success:false, errors:"existing user found with same emailId or email address"})
}
let cart={};
for(let i =0 ; i < 300; i++){
    cart[i]=0
...
//creating endpoint for  creating newcollections data
...
//Creating middlewarre to fetch user
